...
@REM cd %OPEN_SSL%
@REM perl Configure VC-WIN32 --prefix=%cd%\openssl-dev
@REM call "%VCVSRS32%\vcvars32.bat"
@REM "%NMAKE%"
@REM "%NMAKE%" install
...
"%MSBUILD%\MSBuild.exe" CMakeInstallExample.sln /p:Configuration=Debug /p:Platform="WIN32"
copy ..\demo\* ..\bin\Debug\